...
class QuizBrain {
  ...
  int _questionNumber = 0; // _valtozo means make it private
  ...
  void nextQuestion() {
    if(_questionNumber < _questionBank.length - 1) { //sp when we reach the end of the list it wont crush / stops at the last question
      _questionNumber++;
    }
